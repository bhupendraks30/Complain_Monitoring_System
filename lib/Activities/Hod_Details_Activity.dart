...
class Hod_Details_Activity extends StatefulWidget {
  const Hod_Details_Activity({super.key});

  @override
  State<Hod_Details_Activity> createState() => _Hod_Details_ActivityState();
}

class _Hod_Details_ActivityState extends State<Hod_Details_Activity>  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("HOD Details",style: TextStyle(color: Colors.white),),
